...
add_shortcode('chama','chama_info');

function chama_info(){
    ob_start();
    ?>
    <h1>This is chama infromation </h1>
    <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores ex ea voluptas dignissimos illo veniam cumque, fugiat adipisci amet, odit, dolorum facilis exercitationem voluptates labore? Dolor ex asperiores quisquam nisi!
    </p>
    <?php
    return ob_get_clean();
}
